              ...
              <div key={item.id} className="flex items-start gap-3">
                ...
                <div className="flex-shrink-0 mt-1">
                  {list.type === 'bullet' ? (
                    ...
                    <span
                      className="font-bold text-lg font-cairo"
                ...
                <div className="flex-1">
                  <Input
                    ...
                    className="font-cairo text-gray-700 border-none bg-transparent p-0 focus:ring-0 text-lg"
                    dir="rtl"
                  />
                </div>
                      ...
                      {colorOptions.map((colorOption) => (
                        <SelectItem key={colorOption.value} value={colorOption.value}>
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="font-cairo">{colorOption.name}</span>
                          </div>
                        </SelectItem>
                      ))}
                    </SelectContent>
