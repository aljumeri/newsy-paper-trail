...
import { Plus, Settings, Palette, Facebook, Linkedin, X } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6">
        ...
        <Card className="p-6 border-2 border-dashed border-gray-300 hover:border-logo-blue transition-colors">
          <Button
            onClick={addSection}
            variant="outline"
            className="w-full h-16 text-lg font-cairo hover:bg-logo-blue hover:text-white transition-colors"
          >
        ...
        <div className="text-center py-8 border-t border-gray-200 space-y-6">
          ...
          {/* Subscription Text */}
          <div className="text-gray-600 font-cairo text-sm space-y-2">
            <p>
